...
/// <summary>
/// Classe que armazena as estatísticas do jogador
/// </summary>
[Serializable]
public class PlayerStats
{
    ...
    public float CriticalChance => Mathf.Min(GameConfig.Instance.baseCriticalChance + (Dexterity * GameConfig.Instance.criticalChancePerDexterity), 0.75f);
    public float CriticalMultiplier => GameConfig.Instance.baseCriticalMultiplier + (Dexterity * GameConfig.Instance.criticalMultiplierPerDexterity);
    public float AttackSpeed => GameConfig.Instance.baseAttackSpeed + (Dexterity * GameConfig.Instance.attackSpeedPerDexterity);
    public float CastSpeed => GameConfig.Instance.baseCastSpeed + (Intelligence * GameConfig.Instance.castSpeedPerIntelligence);
    
    // Resistências
    public float PhysicalResistance => Mathf.Min(Vitality * GameConfig.Instance.vitalityScalingPerPoint, GameConfig.Instance.maxPhysicalResistance);
